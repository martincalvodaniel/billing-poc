...
* Clarifications requested to the user must be stored with their questions into $TOPIC/$SUBTOPIC/{NUMBER_OF_SUBAGENT}clarifications; the subagent in charge of this must be called "clarifier"
* All agents and subagents must assume total bypass approvals for using tools and commands in terminal
