## with clarifications
```
Execute .agents/agents/orchestrator.agent.md for agent-iterations/260522-2221_discount-at-payments/main.prompt.md
...
## direct
```
Execute .agents/agents/orchestrator.agent.md for already created main-plan agent-iterations/260522-2221_discount-at-payments/main.prompt.md
