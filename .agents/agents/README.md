## with clarifications
```
Execute .agents/agents/orchestrator.agent.md for agent-iterations/260525-1422_generate-payment-from-events-as-today/main.prompt.md
...
## direct
```
Execute .agents/agents/orchestrator.agent.md for already created main-plan agent-iterations/260525-1422_generate-payment-from-events-as-today/main.prompt.md
