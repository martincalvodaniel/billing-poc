## with clarifications
```
Execute .agents/agents/orchestrator.agent.md for agent-iterations/260524-1913_adding-clients-to-event-fixes-4/main.prompt.md
...
## direct
```
Execute .agents/agents/orchestrator.agent.md for already created main-plan agent-iterations/260524-1913_adding-clients-to-event-fixes-4/main.prompt.md
