...
export default function NumberStepperInput({
  ...
  const inputClassName =
    "h-9 min-w-0 flex-1 appearance-none bg-white px-1 text-center text-sm text-zinc-900 [appearance:textfield] focus:outline-none disabled:opacity-50 dark:bg-zinc-800 dark:text-zinc-100 [&::-webkit-inner-spin-button]:m-0 [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:m-0 [&::-webkit-outer-spin-button]:appearance-none"
